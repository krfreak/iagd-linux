...
namespace IAGrim.Core.Imaging {
    // Copied from iagd/Parser/Arc/DDSPixelFormat.cs: internal to that assembly, and a DDS format
    // struct, so it carries the same near-zero rebase risk as the decoder it belongs to.
